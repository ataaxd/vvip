...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Developer > AtaaXD ${YELLOW}(${NC}${green} Orang Ganteng ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green}RevoerTunnel ${NC}${YELLOW}(${NC} ${green} AtaaXD  ${NC}${YELLOW})${NC}"
echo -e " Code By My Self RevoerTunnel ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ataaxd/vvip/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/ataaxd/vvip/main/REGISTRASI"
# USERNAME
rm -f /usr/bin/user
...
<code>â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</code>
<b> ðŸ‡®ðŸ‡©ðŸ‡®ðŸ‡©RevoerTunnelðŸ‡®ðŸ‡©ðŸ‡®ðŸ‡©</b>
<code>â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</code>
...
wget -q https://raw.githubusercontent.com/ataaxd/vvip/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
